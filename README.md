...
# rex
REx: Relation Extraction. Modernized re-write of the code in the master's thesis: "Relation Extraction using Distant Supervision, SVMs, and Probabalistic First-Order Logic" Thesis is [here](http://reports-archive.adm.cs.cmu.edu/anon/2014/CMU-CS-14-128.pdf).
